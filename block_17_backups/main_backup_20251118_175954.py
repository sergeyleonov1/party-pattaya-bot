...
class PartyPattayaBotV2:
    ...
    async def run_async(self):
        """Асинхронный запуск бота с инициализацией БЛОКА 17"""
        print("\n" + "="*80)
        print("🚀 PARTY PATTAYA BOT v2.0 - ПОЛНАЯ ИНТЕГРАЦИЯ (16 + БЛОК 17)")
        print("="*80 + "\n")
        
        # 🔒 Инициализируем БЛОК 17
        protection_ok = await self.initialize_protection()
